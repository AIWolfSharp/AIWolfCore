...
{
    /// <summary>
    /// Abstract class for medium players.
    /// </summary>
    /// <remarks></remarks>
    public abstract class AbstractMedium : AbstractRole
    {
        /// <summary>
        /// The list of inquests ever done.
        /// </summary>
        /// <value>The list of inquests this medium has ever done.</value>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// Returns whether or not the agent has been already inquired.
        /// </summary>
        /// <param name="agent">The agent to be checked.</param>
        /// <returns>True if the agent has been already inquired, otherwise, false.</returns>
        /// <remarks></remarks>
